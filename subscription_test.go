...
// Running tool: /Users/frank/sdk/go1.17.1/bin/go test -benchmem -run=^$ -bench ^BenchmarkUnmonitorItems$ github.com/jb0n/opcua

// goos: darwin
// goarch: arm64
// pkg: github.com/jb0n/opcua
...
// PASS
// ok  	github.com/jb0n/opcua	116.192s
