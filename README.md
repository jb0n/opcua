...
[![GitHub](https://github.com/jb0n/opcua/workflows/gopuca/badge.svg)](https://github.com/jb0n/opcua/actions)
[![Go Reference](https://pkg.go.dev/badge/github.com/jb0n/opcua.svg)](https://pkg.go.dev/github.com/jb0n/opcua)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/jb0n/opcua/blob/master/LICENSE)
[![Version](https://img.shields.io/github/tag/gopcua/opcua.svg?color=blue&label=version)](https://github.com/jb0n/opcua/releases)

## Note

`v0.2.4` and `v0.2.5` are broken and should not be used. Please upgrade to `v0.2.6` or later.
See [#538](https://github.com/jb0n/opcua/issues/538) for details.
...
# install library
go get -u github.com/jb0n/opcua
...
The [Current State](https://github.com/jb0n/opcua/wiki/Current-State) was moved
to the [Wiki](https://github.com/jb0n/opcua/wiki).
...
The [Gopcua Team](https://github.com/jb0n/opcua/graphs/contributors).
...
[MIT](https://github.com/jb0n/opcua/blob/master/LICENSE)
